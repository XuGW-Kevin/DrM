...
Install Azcopy first https://learn.microsoft.com/en-us/azure/storage/common/storage-use-azcopy-v10.
...
```
pip install git+https://github.com/microsoft/dexter-benchmarks-metaworld.git
```

Alternatively, you can clone the repository and install an editable version locally:

```
git clone https://github.com/microsoft/dexter-benchmarks-metaworld.git
cd metaworld
pip install -e .
```

### Constructing a single-task MetaWorld environment for Project Dexter's purposes

See the [metaworld.mw_gym_make(.)](https://github.com/microsoft/dexter-benchmarks-metaworld/blob/dev_akolobov/testing/metaworld/__init__.py#L324) method. For an example of how to use it, see         the [data/training_data_gen.py](https://github.com/microsoft/dexter-benchmarks-metaworld/blob/fa4427ae3eade08b1cdac742dd9d094e6f1dece6/metaworld/data/training_data_gen.py#L81) script.


### Recording demos from a scripted policy for a given MetaWorld task for Project Dexter's purposes

See the [data/training_data_gen.py](https://github.com/microsoft/dexter-benchmarks-metaworld/blob/fa4427ae3eade08b1cdac742dd9d094e6f1dece6/metaworld/data/training_data_gen.py#L81) script.
